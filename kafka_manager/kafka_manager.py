...
from config import (
    ...
    KAFKA_BOOTSTRAP_SERVERS, OUTAGE_EVENT_TOPIC, SCALING_ACTION_TOPIC, RAW_TELEMETRY_TOPIC, STRUCTURED_TELEMETRY_TOPIC # New imports
)
...
def ensure_kafka_topics_exist_managed():
    ...
    required_topics = [OUTAGE_EVENT_TOPIC, SCALING_ACTION_TOPIC, RAW_TELEMETRY_TOPIC, STRUCTURED_TELEMETRY_TOPIC]
